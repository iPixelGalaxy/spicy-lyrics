...
export default function LyricsSection({ query, sectionFilter }: Props) {
  ...
  return <>
    ...
    {r7 && <Row label="Space Gravity Mode" description="Let word-synced lyrics drift and tumble freely while their timing animations continue."><Toggle checked={spaceGravityMode} onChange={(v) => $spaceGravityMode.set(v)} /></Row>}
