      ...
      <div className="x-settings-row eguwzH_QWTBXry7hiNj3">
        ...
        <div className="x-settings-secondColumn jKCZodyn7H2Trr7dhvGm">
          {props.field.type === "input" ? (
            ...
            <div className="x-settings-dropdownWrapper">
              <select
                className="main-dropDown-dropDown FQupgLGfMkp1dOYvUeuQ x-settings-dropdown"
                id={id}
                {...props.field.events}
                onChange={(e) => {
                  setValue(
              ...
              <span className="x-settings-dropdownArrow" aria-hidden="true">
